...
* No code execution: You MUST NOT compile or run any tests, scripts, files, code snippets or any other code. All commands you run MUST be from the <allowed_commands> list.
